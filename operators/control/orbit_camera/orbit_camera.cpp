...
struct OrbitCamera : vivid::OperatorBase, vivid::FrameProcessable {
    ...
    void collect_ports(std::vector<VividPortDescriptor>& out) override {
        out.push_back({"cam_x",    VIVID_PORT_SCALAR, VIVID_PORT_OUTPUT});
        out.push_back({"cam_y",    VIVID_PORT_SCALAR, VIVID_PORT_OUTPUT});
        out.push_back({"cam_z",    VIVID_PORT_SCALAR, VIVID_PORT_OUTPUT});
